...
def main():
    """
    Main method that preprocesses the years and feeds the correct url and file name to the function
    necessary for creating the csv of soccer transfers for listed years.
    """
    year = ['2017', '2018', '2020']
    url = 'https://www.transfermarkt.us/premier-league/transfers/wettbewerb/GB1/plus/?saison_id=2017&s_w=&leihe=0&intern=0&intern=1'
    url_begin = 'https://www.transfermarkt.us/premier-league/transfers/wettbewerb/GB1/plus/?saison_id='
...
def write_transfer_file(url, file_path):
    ...
    season specified by the TransferMarkt url. Writes row for each player in the form
    of ['Name', 'Position', 'Market Value', 'Actual Fee', 'New Team', 'Old Team'].
    """
