...
def extrapolate_2020_data(data_17, data_18):
    ...
    of clubs across the league in 2020. Writes a csv to the current directory
    with the information in addition to a png plot.
...
def covid_effects(data_20):
    ...
    for the average calcualted losses due to COVID-19. Writes a csv to the
    current directory and a png of the plot of basic stats.
