...
def financial_analysis(cpo_2017, cpo_2020):
    ...
    print("The average turnover/revenue for a Premier League club in 2017 was "
          + str(turnover_2017) + " euros, while in 2018 it was "
          + str(turnover_2018) + " euros.")
    ...
    print("Using the change from the 2017 to the 2018 season, we estimated" +
          ...
          str(turnover_2020) + " million euros" +
    ...
    pred_financials = pd.read_csv('pred_financials_2020.csv')
    pred_covid_finances = pd.read_csv('pred_covid_finances_2020.csv')
    ...
    print("With our estimated effect of coronavirus on" +
          ...
          " is 20% of their revenue. This is then multiplied by " +
