...
def main():
    ...
    replace the year (2018) with another year (2020) to scrape a different
    season.
    """
    first = ['https://www.transfermarkt.us/fc-chelsea/startseite/'
             'verein/631/saison_id/2018',
             'https://www.transfermarkt.us/manchester-united/startseite/'
             'verein/985/saison_id/2018',
             'https://www.transfermarkt.us/fc-arsenal/startseite/'
             'verein/11/saison_id/2018',
    ...
    second = ['https://www.transfermarkt.us/tottenham-hotspur/startseite/'
              ...
              'verein/31/saison_id/2018',
              'https://www.transfermarkt.us/fc-everton/startseite/'
              'verein/29/saison_id/2018',
              'https://www.transfermarkt.us/west-ham-united/startseite/'
              'verein/379/saison_id/2018']
    scraping_function(second)
    time.sleep(10)
    third = ['https://www.transfermarkt.us/leicester-city/startseite/'
             'verein/1003/saison_id/2018',
             'https://www.transfermarkt.us/fc-southampton/startseite/'
             'verein/180/saison_id/2018',
             'https://www.transfermarkt.us/crystal-palace/startseite/'
             'verein/873/saison_id/2018',
    ...
    fourth = ['https://www.transfermarkt.us/swansea-city/startseite'
              ...
              'verein/1010/saison_id/2018',
              'https://www.transfermarkt.us/newcastle-united/startseite/'
              'verein/762/saison_id/2018',
    ...
    fifth = ['https://www.transfermarkt.us/afc-bournemouth/startseite/'
             ...
             'startseite/verein/1237/saison_id/2017',
             'https://www.transfermarkt.us/fc-burnley/startseite/'
             'verein/1132/saison_id/2017',
             'https://www.transfermarkt.us/huddersfield-town/startseite/'
             'verein/1110/saison_id/2017']
    scraping_function(fifth)


def scraping_function(list_of_urls):
    """
    Function takes the list of urls and scrapes the urls for the information of
    every team's player and market value, and then appends into a csv the entry
    in the format [Name, Value, Team]. Has a sleep timer so the connection
    isn't rest by TransferMarkt. Changed csv name based on year we were
    intending to scrape.
    """
    ...
    for url in list_of_urls:
        ...
        players = soup.find("table", class_="items").find("tbody")
        players = players.find_all("tr", recursive=False)
